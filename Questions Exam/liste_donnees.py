...
liste_donnees.sort()
chiffre_de_merde = liste_donnees.pop(0)
chiffre_de_merde1 = liste_donnees.pop(-1)
print(f"voici le dernier élément et le premier de la liste {chiffre_de_merde} et {chiffre_de_merde1}")
print(liste_donnees)