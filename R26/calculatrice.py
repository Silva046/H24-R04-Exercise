...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.multiple = customtkinter.CTkButton(self.btn_frame,text='x',height=100,width=100,fg_color='grey',command=lambda : self.ajout_formule(' x '),font=('',40),state='enabled').grid(row=2,column=3)
    ...
    def ajout_formule(self,caractere):
        ...
        longueur = len(self.ecran.get())
        self.ecran.insert(longueur,caractere)
